(function(){
  ...
  function show(item,preview){
    ...
    const test=document.createElement('span');test.className='navi-news-test';test.textContent='TEST ADMIN';kicker.appendChild(test);
    ...
    actions.appendChild(close);card.append(kicker,title,message,actions);overlay.appendChild(card);document.body.appendChild(overlay);close.focus();
  }
